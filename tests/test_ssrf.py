...
def test_multicast_ipv4_rejected():
    # Le multicast doit aussi être rejeté au submit (cohérent avec
    # is_ip_allowed, source unique).
    with pytest.raises(ValueError):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "fd00::1",
        "0.0.0.0",
        # multicast : `is_global` seul les laissait passer.
        ...
        "ff02::fb",             # mDNS IPv6
        # NAT64 / IPv4-embedding : IPv6 « globale » qui
