...
## Global Constraints
- `ocular/` uniquement (périmètre = ce dépôt). DRY. Ne PAS régresser le chemin capture 3a sans Turnstile (pas de widget → comportement inchangé, screenshot initial + suite normale). Logs jamais de secret/URL sensible.
