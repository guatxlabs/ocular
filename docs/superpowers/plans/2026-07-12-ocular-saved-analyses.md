...
**SOUS-COMPÉTENCE** : `frontend-design` ; réutiliser le système de style existant (`.card`, `.qtable`, `.sev`, accent violet). Anti-XSS : données via `textContent`/`setAttribute`, jamais `innerHTML`.
