...
*Dernière mise à jour : 2026-07-19 (publication publique AGPL sur guatxlabs/ocular). Voir `docs/superpowers/specs/` et `docs/superpowers/plans/` pour le détail de chaque phase.*
