...
"""
vision.py — port d'un module de vision interne dans runner_recon (Ocular).

Élagué au strict nécessaire pour capture.py : seules les briques réellement
utilisées par Ocular sont conservées, reprises du module de vision interne
(détection / gestuelle) :
...
async def human_click_xdotool(sx, sy, aim_min=0.6, aim_max=1.2, jitter=True, click=True):
    ...
    au module de vision interne — celle qui passe les Turnstile interactifs."""
    x0, y0 = _xdo_pos()
